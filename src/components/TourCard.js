        ...
        <div className="flex flex-row">
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex flex-col w-full">
                    ...
                    <a href={program} target="_blank" rel="noreferrer" className="border-2 border-[#ff9900] text-[#ff9900] font-oswald font-extralight text-xl lg:text-2xl px-2 lg:px-6 py-1 lg:py-2 rounded-lg hover:bg-[#cb69281a] w-max">Programa</a>
                </div>
            </div>
        </div>
    );
